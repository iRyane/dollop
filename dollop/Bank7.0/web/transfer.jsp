	  ...
	  <div class='login_fields'>
		  <form action="transfer.do" method="post">
			  <div class='login_fields__user'>
				  <%--<div class='icon'>--%>
					  <%--&lt;%&ndash;<img alt="" src='img/user_icon_copy.png'>&ndash;%&gt;--%>
				  <%--</div>--%>
				  <input name="inAccount" placeholder='转账账户' maxlength="16" type='text' autocomplete="off" />
			  ...
			  <div class='login_fields__password'>
				  ...
				  <%--</div>--%>
				  <input name="money" placeholder='金额' maxlength="16" type='text' autocomplete="off">
				  <div class='validation'>
					  <img alt="" src='img/tick.png'>
				  </div>
			  </div>
			  ...
			  <div class='login_fields__submit'>
				  ...
				  <div>
				  <input type='button' value='返回' onclick="window.location.href='login.jsp'" style="margin-left: 142px;margin-top: -55px;">
				  </div>
