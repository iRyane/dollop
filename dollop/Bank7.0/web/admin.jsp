	  ...
	  <div class='login_fields'>
		  <form action="admin.do" method="post">
			  <div class='login_fields__user'>
				  ...
				  <%--</div>--%>
				  <input name="name" placeholder='冻结账户' maxlength="16" type='text' autocomplete="off" />
			  ...
			  <div class='login_fields__submit'>
				  ...
				  <div>
				  <input type='button' value='退出' onclick="window.location.href='index.jsp'" style="margin-left: 142px;margin-top: -55px;">
				  </div>
