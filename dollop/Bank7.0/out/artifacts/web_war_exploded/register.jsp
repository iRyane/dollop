	  ...
	  <div class='login_fields'>
		  <form action="register.do" method="post">
			  ...
			  <div class='login_fields__password'>
				  ...
				  <input name="repass" placeholder='确认密码' maxlength="16" type='text' autocomplete="off">
				  <div class='validation'>
			  ...
			  <div class='login_fields__submit'>
				  ...
				  <input type='button' value='返回' onclick="window.location.href='index.jsp'" style="margin-top: -55px;margin-left: 130px;">
